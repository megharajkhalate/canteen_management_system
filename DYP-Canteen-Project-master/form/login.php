...
<div class="middle" style=" margin:0px auto;width:500px;">
	   ...
	   <!--login Section-- starts-->
            ...
            <div class="tab-pane fade show active" id="login" role="tabpanel" aria-labelledby="home-tab"  style="color:white">
            ...
            <div class="tab-pane fade" id="signup" role="tabpanel" aria-labelledby="profile-tab" style="color:white">
			    <form method="post" enctype="multipart/form-data">
                    <div class="form-group">
                      <label for="name">Name</label>
                      <input type="text" id="name"  class="form-control" name="name"  autocomplete = "off" required="required"/>
                    </div>
				   ...
				   <div class="form-group">
                      ...
                      <input type="tel" id="mobile" class="form-control" name="mobile" pattern="[6-9]{1}[0-9]{2}[0-9]{3}[0-9]{4}"  autocomplete = "off" placeholder="" required>
                    </div>
